...
public class PlayerKillListener extends DeathSystems.OnDeathSystem {
    private final HytaleFoundations hytaleFoundations;
    public PlayerKillListener(HytaleFoundations hytaleFoundations) {
    ...
    public void onComponentAdded(@Nonnull Ref<EntityStore> ref, @Nonnull DeathComponent deathComponent, @Nonnull Store<EntityStore> store, @Nonnull CommandBuffer<EntityStore> commandBuffer) {
        try {
            ...
            if(ref.equals(attackerRef)) return;
            ...
            FileManager.logError("PlayerKillListener", e);
        }
    }
