...
public class TpahereCommand extends AbstractPlayerCommand {
    ...
    public TpahereCommand(HytaleFoundations hytaleFoundations) {
        super("tpahere", "Request another player to teleport to you.");
        this.requirePermission(Permissions.TPA.getPermission());
        this.hytaleFoundations = hytaleFoundations;
        this.targetArg = withRequiredArg("target", "Player you want to summon.", ArgTypes.PLAYER_REF);
    }
    ...
    protected void execute(@Nonnull CommandContext commandContext, @Nonnull Store<EntityStore> store,
        ...
        tm.requestTpa(playerRef, target, true);
    }
}
